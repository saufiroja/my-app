...
const EditProfile = (props) => {
    ...
    return (
        <div className="bg-white no-repeat bg-cover h-screen w-screen font-body relative overflow-hidden">
            <div className="absolute xl:ml-[-215px] xl:mt-[-185px] lg:ml-[-215px] lg:mt-[-185px] md:ml-[-215px] md:mt-[-185px] sm:hidden">
            ...
            <div className="absolute xl:top-[-12%] xl:right-[-40%] lg:top-[-32%] lg:right-[-60%] md:top-[-12%] md:right-[-93%] sm:hidden">
            <Image src="/images/ungu.svg" alt="impostor-logo" width={964} height={964}/>
            </div>
            <div className="absolute xl:left-[70%] xl:top-[34%] lg:left-[70%] lg:top-[34%] md:left-[70%] md:top-[40%] sm:hidden">
            <Image src="/images/game.svg" alt="impostor-logo" width={458} height={308}/>
            </div>
            <div className="absolute xl:left-[82%] xl:top-[78%] lg:left-[82%] lg:top-[70%] md:left-[82%] md:top-[67%] sm:hidden">
            <Image src="/images/batu.svg" alt="impostor-logo" width={79} height={31}/>
            </div>
            <div className="container mx-auto px-[6%]">
                <div className="h-screen w-5/12 pt-[80px] ml-20">
