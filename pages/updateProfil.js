                ...
                <div className="flex flex-row">
                    ...
                    <div className="basis-1/3">
                        <div className="flex items-center w-full mr-4">
                            <input class="focus:ring-2 focus:ring-blue-500 focus:outline-none mt-[176px] appearance-none text-sm leading-6 text-slate-900 placeholder-slate-400 rounded-xl py-2 pl-10 ml-4 w-5/6 ring-1 ring-slate-200 shadow-sm" type="text" aria-label="Filter projects" placeholder="Search Username..."></input>
                        </div>
                    </div>
                </div>
            </div>
